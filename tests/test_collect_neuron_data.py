...
def make_test_files():
    ...
    collect_neuron_data(data_dir, expected_file, pattern="times_*.mat", nbins=50, verbose=True, keep_duplicates=False)
...
def test_collect_neuron_data(tmp_path):
    ...
    collect_neuron_data(data_dir, output_file, pattern="times_*.mat", nbins=50, verbose=True, keep_duplicates=False)
