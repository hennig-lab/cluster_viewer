...
def make_test_files():
    ...
    make_spikes_matrix(str(data_dir), expected_file, ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=None)

    expected_file = str(data_dir / "expected_spike_matrix_ignore_clusters.mat")
    make_spikes_matrix(str(data_dir), expected_file, ignoreClusters=True, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=None)

    expected_file = str(data_dir / "expected_spike_matrix_ignore_duplicates.mat")
    make_spikes_matrix(str(data_dir), expected_file, ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=True, exclusionfile=None)

    expected_file = str(data_dir / "expected_spike_matrix_with_exclusions.mat")
    exclusion_file = str(data_dir / "clusters_excluded.csv")
    make_spikes_matrix(str(data_dir), expected_file, ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=exclusion_file)

    expected_file = str(data_dir / "expected_spike_matrix_default_options.mat")
    exclusion_file = str(data_dir / "clusters_excluded.csv")
    make_spikes_matrix(str(data_dir), expected_file, ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=True, exclusionfile=exclusion_file)
...
def test_make_spikes_matrix_base(tmp_path):
    ...
    make_spikes_matrix(str(data_dir), str(output_file), ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=None)
...
def test_make_spikes_matrix_ignore_clusters(tmp_path):
    ...
    make_spikes_matrix(str(data_dir), str(output_file), ignoreClusters=True, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=None)
...
def test_make_spikes_matrix_ignore_duplicates(tmp_path):
    ...
    make_spikes_matrix(str(data_dir), str(output_file), ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=True, exclusionfile=None)
...
def test_make_spikes_matrix_with_exclusions(tmp_path):
    ...
    make_spikes_matrix(str(data_dir), str(output_file), ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=False, exclusionfile=exclusion_file)
...
def test_make_spikes_matrix_default_options(tmp_path):
    ...
    make_spikes_matrix(str(data_dir), str(output_file), ignoreClusters=False, includeClusterZero=False, ignoreForced=False, ignoreDuplicates=True, exclusionfile=exclusion_file)
